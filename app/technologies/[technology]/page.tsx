...
interface PageProps {
  ...
  searchParams: Promise<{ difficulty?: string; category?: string; type?: string; level?: string; page?: string }>;
}
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
        {all.length} {all.length === 1 ? "question" : "questions"} tagged with {name} as a technology, across every
